...
@if ($rolNombre != 'ADMIN' && $rolNombre != 'SUPERADMIN')
    <div class="alert alert-info">👋 Hola {{ auth()->user()->Username }}. Panel de gestión de rendimiento para tu grupo asignado.</div>
@endif
    ...
    <div class="table-responsive">
        <table class="table table-hover table-sm">
            ...
            <tbody>
                ...
                @empty
                    <tr>
                        <td colspan="8" class="text-center text-muted py-4">No hay registros de rendimiento guardados todavía.</td>
                    </tr>
                @endforelse
            </tbody>
        </table>
